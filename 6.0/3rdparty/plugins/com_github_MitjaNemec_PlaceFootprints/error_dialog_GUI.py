...
class ErrorDialogGUI ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Place Footprints", pos = wx.DefaultPosition, size = wx.Size( 458,212 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self.m_hyperlink1 = wx.adv.HyperlinkCtrl( self, wx.ID_ANY, u"https://github.com/MitjaNemec/PlaceFootprints", u"https://github.com/MitjaNemec/PlaceFootprints", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
        bSizer1.Add( self.m_hyperlink1, 0, wx.ALL, 5 )

        self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, u"Please attach the place_footprints.log which you should find in the project folder.", wx.DefaultPosition, wx.DefaultSize, 0 )
